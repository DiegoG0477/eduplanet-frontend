  ...
  return (
    <div>
                    ...
                    {blogs.map((blog,index) =>(
                            <div key={index}>
                                <Link href={`/blogs/${[blog.id_blog]}`} className="quitarLink">
                                    <CardBlog titulo={blog.titulo} contenido={blog.texto_contenido} fecha={blog.created_at} imagen={blog.url_imagen} creado={blog.created_by}/>
                                </Link>
                            </div>
                    ))}
                    </div>
